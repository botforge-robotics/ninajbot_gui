<template>
  <div
    ...
    id="ntsModal"
    tabindex="-1"
    aria-labelledby="ntsLabel"
    aria-hidden="true"
  >
    <div class="modal-dialog" id="ntsModalContent">
      <div class="modal-content" >
        <div class="modal-header">
          <h1 class="modal-title fs-5 fw-bold" id="ntsLabel">Nodes,Topics,Services and Actions.</h1>
          <button
            type="button"
            class="btn-close"
        ...
        <div class="modal-body">
          <div>
            <div
              class="rounded-pill fs-4 bg-dark text-bg-dark ps-4 pe-4 pt-2 pb-2"
            >
              Nodes:
            ...
            >
              ...
              <p class="col-3 text-center fs-5 fw-bold text-muted">
                Publishers
              </p>
              <p class="col-3 text-center fs-5 fw-bold text-muted">
                Subscribers
            ...
            <div class="d-flex flex-row justify-content-evenly">
              ...
              <div v-else class="col-9">
                No Publishers Subscribers & services
              </div>
            </div>
          </div>
          ...
          <div class="d-flex flex-row">
            ...
            <div class="mt-4 col-6 pe-2">
              ...
              >
                ...
                >
                  {{ topic.topic }}
                  <span class="text-muted">({{ topic.msgTyp }})</span>
                </li>
              </ul>
          ...
          <div class="mt-4 w-50">
            ...
            >
              Action Servers:
              <span class="badge bg-warning">{{
                actionsServersList.serversCount
              }}</span>
            </div>
            <ul
              class="list-group list-group-flush overflow-auto mt-3"
...
#ntsModalContent>.modal-content>.modal-body{
  max-height:80vh;
  overflow-y:scroll;
}
